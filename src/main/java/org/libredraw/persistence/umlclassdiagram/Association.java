...
@Entity
public class Association extends DiagramEntity implements Serializable {
	...
	public Association(String name, DiagramEntity left, DiagramEntity right, String leftName, String leftMultiplicity, String rightName, String rightMultiplicity, AssociationType type,  Key<LDUser> createdBy) {
