...
public final class Util {
	...
	//Javascript implementation of the sha1 function.
	...
	/**
	 * Get the SHA-1 Hash of a string, used for password storage.
	 * 
	 * This function credit to:
	 * <code>http://www.anyexample.com/programming/java/java_simple_class_to_compute_sha_1_hash.xml</code>
	 * 
	 * @param password string that will be hashed.
	 * @return result of hash
	 */
	public static String sha1Java(String password) {
		MessageDigest md;
	...
	/**
	 * Converts binary data to hex representation in string.
	 * 
	 * This function credit to:
	 * <code>http://www.anyexample.com/programming/java/java_simple_class_to_compute_sha_1_hash.xml</code>
	 * 
